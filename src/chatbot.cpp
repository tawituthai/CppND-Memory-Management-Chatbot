...
{
  std::cout << "COPYING (constuctor) content of instance " << &source
...
{
  std::cout << "COPYING (assign) content of instance " << &source
            << " to instance " << this << std::endl;
  if (this == &source)
    return *this;
...
{
  std::cout << "MOVING (constuctor) content of instance " << &source
            << " to instance " << this << std::endl;
...
{
  std::cout << "MOVING (assign) content of instance " << &source
            << " to instance " << this << std::endl;
